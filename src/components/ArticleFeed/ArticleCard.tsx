...
const ArticleCard: React.FC<ArticleCardProps> = ({ article }) => (
  <div className='max-w-[680px] flex flex-row mx-auto p-4 rounded-2xl space-x-8 items-center bg-[#f5f5f7] border-transparent shadow-none hover:bg-gray-50   cursor-pointer hover:shadow-xl transition-all duration-300 ease-in-out'>
